  ...
  return (
    <>
      <form 
        ...
        id="gform"
        method="POST"
        action="https://docs.google.com/forms/d/1XcKNVCw5f4guryFLpZirrBFCBVsQ4xgmj_QPLnG5T0E/formResponse?"
        target="hidden_iframe"
        onSubmit={handleSubmit}
        >
          <input type="email" name="entry.1389542684" id="entry.1389542684" placeholder="Enter Email Address" />
