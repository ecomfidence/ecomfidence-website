...
export default function ProductEcom() {
    return (
        <>
                            ...
                            <div className="about-product-content ps-xxl-10">
                                <div className="pricing-title">
                                    ...
                                    <h2 className="stitle mb-xxl-8 mb-xl-7 mb-xl-5 mb-4" data-aos="fade-up" data-aos-duration={1600}>
                                        Stay Ahead <span className="fw-400 theme-clr">Confidently</span>
                                    </h2>
                                    <p className="white-clr mb-xxl-9 mb-xl-7 mb-xl-6 mb-6" data-aos="fade-up" data-aos-duration={1900}>
                                    At Ecomfidence, we stay at the forefront of the e-commerce landscape. 
                                    We've evolved from PrestaShop to WooCommerce and now specialize in Shopify, 
                                    the most robust and scalable platform for modern businesses. 
                                    As technology evolves, so do we, ensuring your store is always up-to-date with the latest trends 
                                    and innovations. Ready to upgrade your online store? We'll guide you every step of the way.
                                    </p>
