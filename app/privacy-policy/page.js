                                            ...
                                            <div className="mb-xxl-13 mb-xl-10 mb-lg-8 mb-7">
                                                ...
                                                <ol className="pra-clr mb-xxl-5 mb-3" data-aos="fade-left" data-aos-duration={1700}>
                                                    <li className="d-flex align-items-center gap-2">
                                                        <i className="fas fa-chevron-right" /> Visit our website (ecomfidence.com)
                                                    </li>
                                                    <li className="d-flex align-items-center gap-2">
                                                        <i className="fas fa-chevron-right" /> Use our services, including Shopify development, consulting, and support
                                                    </li>
                                                    <li className="d-flex align-items-center gap-2">
                                                        <i className="fas fa-chevron-right" /> Contact us through email, phone, or other means
                                                    </li>
                                                    <li className="d-flex align-items-center gap-2">
                                                        <i className="fas fa-chevron-right" /> Provide personal data to us through any means
                                                    </li>
                                                </ol>
                                            </div>
                                            <div className="mb-xxl-13 mb-xl-10 mb-lg-8 mb-7">
                                                ...
                                                <ol className="pra-clr mb-xxl-5 mb-3" data-aos="fade-left" data-aos-duration={1700}>
                                                    <li className="d-flex align-items-center gap-2">
                                                        <i className="fas fa-chevron-right" /> Contact Information: name, email address, phone number, and physical address
                                                    </li>
                                                    <li className="d-flex align-items-center gap-2">
                                                        <i className="fas fa-chevron-right" /> Website Usage Data: IP address, browser type, device type, operating system, and browsing history
                                                    </li>
                                                    <li className="d-flex align-items-center gap-2">
                                                        <i className="fas fa-chevron-right" /> Communication Data: emails, messages, and other communication records
                                                    </li>
                                                    <li className="d-flex align-items-center gap-2">
                                                        <i className="fas fa-chevron-right" /> Shopify Store Data: store name, store URL, and other Shopify-related information (if you're a Shopify merchant)
                                                    </li>
                                                </ol>
                                            </div>
                                            <div className="mb-xxl-13 mb-xl-10 mb-lg-8 mb-7">
